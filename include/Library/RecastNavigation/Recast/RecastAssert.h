...
typedef void (rcAssertFailFunc)(const char* expression, const char* file, int line); //这是一个回调函数,用于判断断言失败时的会滴函数式
...
void rcAssertFailSetCustom(rcAssertFailFunc *assertFailFunc);//设置断言失败的函数
