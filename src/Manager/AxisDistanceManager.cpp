...
{
	ActorID minActorID = GEN_AABB_POINT_TYPE(actorID,((ActorID)PointPosType::POS_BODY_LIMIT_MIN)); //生成最小ID
	ActorID maxActorID = GEN_AABB_POINT_TYPE(actorID,((ActorID)PointPosType::POS_BODY_LIMIT_MAX)); //生成最大ID 
