...
static const float RC_PI = 3.14159265f;//圆周率

/// Recast log categories.
/// @see rcContext
enum rcLogCategory
{
	RC_LOG_PROGRESS = 1,	///< A progress log entry. 打印log
	RC_LOG_WARNING,			///< A warning log entry.  警告log
	RC_LOG_ERROR,			///< An error log entry.   错误log
};
